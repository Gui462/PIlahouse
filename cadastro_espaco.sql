...
CREATE TABLE `espaco` (
  `codEspaco` tinyint(4) NOT NULL AUTO_INCREMENT,
  `nomeEspaco` varchar(15) NOT NULL,
  `descricao` text NOT NULL,
  `tipo` varchar(15) NOT NULL,
  `largura` double NOT NULL,
  `comprimento` double NOT NULL,
  `valorHora` double NOT NULL,
  `quantidadeTotal` tinyint(4) NOT NULL,
...
INSERT INTO `espaco` VALUES (1,'MINERVA','SALA COMPARTILHADA','COWORKING',2,3,6,8);
...
-- Dump completed on 2019-06-07 20:17:36
